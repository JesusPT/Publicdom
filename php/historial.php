<?php
  ...
  if (@$enlace = new mysqli("localhost","root","","publidom")) {
    $consulta = "SELECT pro.idProducto,nomProducto,descripcion from producto pro INNER JOIN historiales his ON pro.idProducto = his.idProducto and idUsuario = '".$user."'";
